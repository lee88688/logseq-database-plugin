...
type DropdownMenuSwitchItemElement = React.ReactComponentElement<
  typeof DropdownMenuSwitchItem,
      ...
      <DropdownMenu>
        ...
        <DropdownMenuContent>
          <Editor value={cell.getValue()}>
            {(val, onChange) => <Input value={val} onChange={(e) => onChange(e.target.value)} />}
          </Editor>
          <DropdownMenuSeparator />
          ...
          <DropdownMenuSwitchGroup>
            ...
            <DropdownMenuSwitchItem id="23" menu="new">
              xxx
            </DropdownMenuSwitchItem>
          </DropdownMenuSwitchGroup>
        </DropdownMenuContent>
